...
const RULES: Rule[] = [
  ...
  // Foto yukleme -- her cehd Cloudinary-ye gedir, ona gore daha sixdir.
  ...
  { method: 'POST', path: '/api/rag/admin/entities', ip: [intEnv('RL_RAG_ENTITIES_IP', 30), 60 * MIN] },
  ...
  },
  {
    method: 'GET',
    path: '/api/rag-search',
    ip: [intEnv('RL_RAG_SEARCH_IP', 30), 15 * MIN],
    global: [intEnv('RL_RAG_SEARCH_GLOBAL', 1200), 60 * MIN],
  },
