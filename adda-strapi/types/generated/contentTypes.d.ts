...
export interface ApiHeroHero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addaProgram: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    honors: Schema.Attribute.Component<'hero.honor', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    martyrdomDate: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    martyrdomPlace: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    studyYears: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiUnitUnit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    receptionSlots: Schema.Attribute.Component<'unit.reception-slot', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    sortOrder: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<100>;
    strategy: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
