// F2.6e-2 / Magic-link təsdiqi — /[locale]/kimlik/tesdiq
// Token QƏSDƏN serverdə oxunmur — VerifyIsland onu `window.location`-dan alır.
// Beləliklə səhifə statik qalır və token server HTML-inə düşmür.
...
import VerifyIsland from '../../../_components/VerifyIsland';
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: tr('Kimlik təsdiqi', locale), robots: { index: false, follow: false } };
}
    ...
    <>
      ...
      <main className="idn-page">
        <div className="container">
          <VerifyIsland locale={locale} labels={labels} />
        </div>
      </main>
