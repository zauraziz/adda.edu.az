// K27b — sabiq rektorlar: EHTIYAT (fallback) məlumat.
//
// ƏSAS MƏNBƏ ARTIQ STRAPI-DİR (`api::rector.rector`) — redaktə admin
// panelindən gedir. Bu modul yalnız Strapi cavab vermədikdə işə düşür.
//
// NİYƏ SAXLANILIR: Render pulsuz tarifdə yuxuya gedir, soyuq start 30-60 s
// çəkir. Fallback olmasaydı səhifə həmin anda BOŞ görünərdi — statik
// fayldan işləyən indiki vəziyyətə nisbətən geriləmə olardı.
//
// Bu fayl `tools/rectors/data.py`-dan generasiya olunur; Strapi seed bloku
// da eyni mənbədəndir. Ona görə ƏLLƏ REDAKTƏ ETMƏ — məzmun dəyişikliyi
// Strapi admin panelində edilir, bu surət isə növbəti paketdə yenilənir.
...
export const RECTORS_FALLBACK: Record<Locale, Rector[]> = {
  az: [
    {
