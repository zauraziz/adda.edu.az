// AVTOMATIK GENERASIYA — ƏL İLƏ REDAKTƏ ETMƏ.
//
// Mənbə: canlı Strapi (`api::rector.rector`).
// Yeniləmək: `node tools/rectors/sync.mjs`
//
// Bu, yalnız EHTİYAT surətidir. Render pulsuz tarifdə yuxuya gedir;
// soyuq startda səhifə boş qalmasın deyə saxlanılır. Səhifə normal
// halda birbaşa Strapi-dən oxuyur.
